...
The option `-std=c++14` should be included. This builds the `EMFC` binary.
...
$ ./EMFC -func=format -gname=facebook -pdist=wc
$ ./EMFC -func=format -gname=facebook -pdist=wc -wcvariant=1.2

//the uniform setting
$ ./EMFC -func=format -gname=facebook -pdist=uniform -pedge=0.01

//the skewed setting with exponential or weibull distribution
$ ./EMFC -func=format -gname=facebook -pdist=skewed -skew=exp
$ ./EMFC -func=format -gname=facebook -pdist=skewed -skew=weibull
```
...
$ ./EMFC -func=im -gname=facebook -seedsize=100 -eps=0.01

//use the vanilla method to sample RR sets
$ ./EMFC -func=im -gname=facebook -seedsize=100 -eps=0.01 -vanilla=1
```
...
$ ./EMFC -func=format -gname=facebook -pdist=uniform -pedge=0.5

//influence maximization
$ ./EMFC -func=im -gname=facebook -seedsize=100 -eps=0.01 -hist=1
```
